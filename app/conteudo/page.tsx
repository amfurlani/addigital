...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Conteúdo Jurídico | AD Advocacia Digital',
    description:
...
export default function Page() {
  /*
   * Exibe apenas áreas que possuem pelo menos
   * um artigo efetivamente relacionado.
   */
  const areasWithArticles = areas.filter((area) =>
    ...
    <>
      ...
      <section className="section content-intro">
        <div className="container narrow">
          ...
          <p className="lead">
            Reunimos análises sobre questões jurídicas que podem
            impactar empresas, profissionais e relações cotidianas.
            Os conteúdos possuem caráter informativo e procuram
            apresentar os temas de forma clara, contextualizada e
          ...
          <div className="container">
            ...
            <div className="content-section-heading">
              <div>
                ...
                <h2>Áreas relacionadas aos conteúdos</h2>
              </div>
        ...
        <div className="container">
          ...
          <div className="article-grid">
            {articles.map((article) => {
              const author = lawyers.find(
                (lawyer) =>
                  lawyer.slug === article.authorSlug
              );
